...
func (ac *AnswerCreate) SetQuestionID(s string) *AnswerCreate {
	ac.mutation.SetQuestionID(s)
	return ac
}
...
func (ac *AnswerCreate) SetOptionID(s string) *AnswerCreate {
	ac.mutation.SetOptionID(s)
	return ac
}

// SetNillableOptionID sets the "option_id" field if the given value is not nil.
func (ac *AnswerCreate) SetNillableOptionID(s *string) *AnswerCreate {
	if s != nil {
		ac.SetOptionID(*s)
	}
	return ac
...
func (ac *AnswerCreate) createSpec() (*Answer, *sqlgraph.CreateSpec) {
	...
	if value, ok := ac.mutation.OptionID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
